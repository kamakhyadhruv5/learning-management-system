...
export default function CourseCard({ course }) {
  ...
  return (
    <div
      ...
      className="bg-[#0D2229]/95 border border-[#1D363E] rounded-2xl overflow-hidden hover:border-[#29444C] hover:bg-[#10272F] transition-all duration-300 group cursor-pointer shadow-lg flex flex-col justify-between"
    >
      <div>
